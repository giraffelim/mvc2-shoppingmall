...
<article>
	...
	<form name="frm" method="post" enctype="multipart/form-data">
		<input type="hidden" name="pseq" value="${productVO.pseq }"> <input
			...
			name="nomakeImg" value="${productVO.image }">
		<table id="list">
			<tr>
				<th>상품분류</th>
			...
			<tr>
				...
				<!-- onKeyUp == 키보드를 놓을때 [입력되었을 때] 이벤트 발생   -->
			</tr>
			<tr>
				<th>베스트상품</th>
				<td><c:choose>
			...
			<tr>
				<th>상세설명</th>
				<td colspan="5"><textarea name="content" rows="8" cols="70"> ${productVO.content}
</textarea></td>
			</tr>
			<tr>
				<th>상품 이미지</th>
				<td colspan="5"><img src="product_images/${productVO.image }"
					width="200pt"> <br> <input type="file" name="image"></td>
			</tr>
		</table>
