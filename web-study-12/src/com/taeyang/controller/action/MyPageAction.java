...
public class MyPageAction implements Action{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MemberVO loginUser = (MemberVO) session.getAttribute("loginUser"); //반환값 Object임으로 형변환
		...
		if(loginUser == null) {
			...
			for(int oseq:oseqList) {
				...
				ArrayList<OrderVO> orderListing = orderDAO.listOrderByID(loginUser.getId(), result.trim(), oseq);	
